...
--
-- Host: localhost
-- Generation Time: Apr 18, 2016 at 10:38 AM
...
INSERT INTO `booking` (`booking_id`, `booking_ref`, `hotel_name`, `username`, `date_in`, `date_out`, `number_room`, `booking_date`, `address_email`) VALUES
...
(109, '9fb4625f2207b3e3e28ac572350cb9902ed588f4', 'Hilton Sofia', 'delete', '2016-04-15', '2019-01-01', 2, '04/15/16', 'dtg1@aber.ac.uk'),
(118, '8a86588c6c899d4101f8b2db212525299bcdb20f', 'City Hotel Veliko Tarnovo', '', '2016-04-16', '2016-04-21', 2, '04/16/16', 'dtg1@aber.ac.uk'),
(119, 'c5ec1d2e0da66da289b042f90f07c26bb5447997', 'Boutique Hotel Tsarevets', '', '2016-04-16', '2016-04-23', 1, '04/16/16', 'dtg1@aber.ac.uk'),
(120, 'cc0197464e0b0bc691a6424bd81e1ad3084a3a1f', 'Hotel Dafi', 'delete', '2016-04-16', '2017-02-01', 1, '04/16/16', 'dtg1@aber.ac.uk'),
(121, '15fdc90ab11f1b5d8ab2776e00718a79401c5bf0', 'Art Plaza Hotel', '', '2016-04-18', '2016-04-19', 2, '04/17/16', 'dtg1@aber.ac.uk'),
(122, '71939088db9f6c8cb1c2daf119853d8e67ac29c9', 'Hotel Elena', '', '2016-04-18', '2016-04-22', 2, '04/17/16', 'dtg1@aber.ac.uk'),
(123, '5cc3f83712a97d37af47b58ccacedebd4b86f5b5', 'Graffit Gallery Hotel', '', '2016-04-18', '2016-04-20', 2, '04/17/16', 'dtg1@aber.ac.uk');
...
(8, 'didi', 'dtg1@aber.ac.uk', '07572219280', 'Hi testing before write up'),
(9, 'didi', 'dtg1@aber.ac.uk', '07572219230', 'hi'),
(10, 'delete', 'delete@delete.com', '07578588965', 'linux mint chrome test'),
(11, 'didi', 'dtg1@aber.ac.uk', '07578874897', 'linux mint mozila 45.0'),
(12, 'eli', 'dtg1@aber.ac.uk', '01234567890', 'testing ssl'),
(13, 'didi', 'dtg1@aber.ac.uk', '09373764222', 'testing in chrome from my pc  version 49.0.2623.112 ');
...
(27, 'didi', 'Hotel Casa del Mare', 'I didnt like it', '04/09/16', 39);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `user_type` enum('user','owner') NOT NULL,
  `name` varchar(100) NOT NULL,
...
INSERT INTO `user` (`user_id`, `username`, `user_type`, `name`, `password`, `email`, `phone`) VALUES
(1, 'dtg1', 'user', 'Didi Gradinarska', 'test', 'didi_gradinarska@abv.bg', '078888898898'),
(10, 'maria', 'user', 'Maria  Koseva Qneva', '$2y$10$g2azsHs1oBlrshdvuQBTM.J8jCSi71DgOdxmGG9LJbOSdDqPNRfXC', 'maria@gmail.com', '07871171359'),
(14, '', 'user', '', '$2y$10$IN5JTE5.BkvXNKITOsVDaeA6r0SQtSqHxhJ3FEKnKmQ2BkZ9Y23l2', '', ''),
(51, 'SevRay', 'user', 'Sev Ray', '$2y$10$yghrpGW.sGbrbr2eprwHXepoqlwH38yFj9hZmnS5r2GKwQ7Hqt0Lq', 'hary99@abv.bg', '07745974355'),
(53, 'jovie12345', 'user', 'jovie', '$2y$10$PJyx5FIa4HNNvVMMTLBoAeDh0t5bvt4tVeiOBjPMJr28UR/ld/WUW', 'jol36@aber.ac.uk', '07787339248'),
(54, 'jovie', 'user', 'jo', '$2y$10$hGJr7Hg9BGIp5JogFkK68OL5BXhVUQqhkK9fVug9IOsX/zqvE83aS', 'jol36@aber.ac.uk', '0773221567'),
(55, 'dave', 'user', 'dave11tets', '$2y$10$1V9PVvkc0eelofGiAzLELurah.cJfEpF9vt1z2Rqg9I7Lo97KCfTK', 'dave@dave.com', '09373764822'),
(58, 'didi', 'user', 'Didi', '$2y$10$rwQVOS4xxEVHTy4BNB3sJO7iWkuuNWAsD5oxCRN0Cn/3DMY7uD/LO', 'didigradinarska@gmail.com', '07572219280'),
(67, 'Hilton Sofia', 'owner', 'Hilton Sofia Hotel', '$2y$10$bX13RS7.L1hsDVB7Tu9k3e.26GtDCoViKpj0NJ80BvofJ9sDWp4de', 'hiltonsofia@hilton.com', '+359-2-933-5000'),
(68, 'abcde', 'user', 'Lyndax Thomas', '$2y$10$ybJe7dJCOek3PfMyKgqA6Oum19u/Oz4exM7DpyVXZt6k1RZ//qhuG', 'ltt@aber.ac.uk', '01970622452'),
(69, 'srr11', 'user', 'Sev Ray', '$2y$10$50JG8KBVrT8v284uL./5Ju33GyEF/YQ/VkFIr.c7ICdUZqKZQNop2', 'srr11@aber.ac.uk', '07745974355'),
(70, 'delete', 'user', 'delete', '$2y$10$IjLFZ4J36WauCcKD/.E.1eDa3a6OQM.dT2tDogrftgHIWtSE8H8zW', 'delete@delete.com', '07578588965');
