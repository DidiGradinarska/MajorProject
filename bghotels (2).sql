...
--
-- Host: localhost
-- Generation Time: Apr 07, 2016 at 05:11 AM
...
CREATE TABLE IF NOT EXISTS `hotel` (
  ...
  `hotel_type` enum('hotel','resort','b&b') NOT NULL,
...
(3, 'test', 'Pamporovo', 'cabin.png', 'gerdgeer', 'rgrgrg', 'drtgr');
...
(2, 2, 'cabin.png', 'Mask of King Teres lived fourth century BC ', '20.00');
